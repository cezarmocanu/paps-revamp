...
const PreviewItemAdded: FC<Props> = ({ className }) => {
  return (
    <div className={clsx("flex p-4 bg-white", className)}>
      <Image
      ...
      <div className="flex flex-col w-full pl-4 gap-4">
        <div className="flex w-full justify-between">
          <div className="flex flex-col gap-1">
            ...
            <span className="text-xl font-semibold mb-2">177.00 RON</span>
            <div className="flex items-center mb-2">
              ...
              <input
                ...
                className="bg-gray-50 border-x-0 border-gray-300 h-11 font-medium text-center text-gray-900 text-sm w-16 block"
                placeholder=""
                value="2"
                required
              />
...
export default PreviewItemAdded;
